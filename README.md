...
| Rule ID                                                                  | Description      |     |
| :----------------------------------------------------------------------- | :--------------- | :-: |
| [complex-condition/complex-condition](./docs/rules/complex-condition.md) | (no description) | ⭐️ |
| [complex-condition/example-rule](./docs/rules/example-rule.md)           | An example rule. | ⭐️ |
